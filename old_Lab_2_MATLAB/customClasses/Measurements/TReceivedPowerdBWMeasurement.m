classdef TReceivedPowerdBWMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Received Power - dBWatt'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods 
        function obj=TReceivedPowerdBWMeasurement %MUST NOT TAKE ARGUMENTS  
