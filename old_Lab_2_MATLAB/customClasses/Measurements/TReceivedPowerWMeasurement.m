classdef TReceivedPowerWMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Received Power - Watt'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods 
        function obj=TReceivedPowerWMeasurement %MUST NOT TAKE ARGUMENTS  
