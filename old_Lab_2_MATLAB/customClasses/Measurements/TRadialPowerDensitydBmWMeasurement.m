classdef TRadialPowerDensitydBmWMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Radial Power Density - dBmW/m^2'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods 
        function obj=TRadialPowerDensitydBmWMeasurement %MUST NOT TAKE ARGUMENTS  
