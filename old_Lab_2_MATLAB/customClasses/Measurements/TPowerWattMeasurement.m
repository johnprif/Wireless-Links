classdef TPowerWattMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Power (Watt)'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods 
        function obj=TPowerWattMeasurement %MUST NOT TAKE ARGUMENTS  
