classdef TCoverageMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Coverage - Watt'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
        Units='Watt';
    end
    
    methods 
        function obj=TCoverageMeasurement %MUST NOT TAKE ARGUMENTS  
