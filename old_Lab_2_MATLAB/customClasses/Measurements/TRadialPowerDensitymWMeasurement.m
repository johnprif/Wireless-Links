classdef TRadialPowerDensitymWMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Radial Power Density - mW/m^2'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods 
        function obj=TRadialPowerDensitymWMeasurement %MUST NOT TAKE ARGUMENTS  
