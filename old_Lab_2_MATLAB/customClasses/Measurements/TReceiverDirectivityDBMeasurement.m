classdef TReceiverDirectivityDBMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Receiver''s Directivity - dB'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods 
        function obj=TReceiverDirectivityDBMeasurement %MUST NOT TAKE ARGUMENTS  
