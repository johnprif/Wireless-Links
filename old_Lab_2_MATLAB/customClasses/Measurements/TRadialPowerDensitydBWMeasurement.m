classdef TRadialPowerDensitydBWMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Radial Power Density - dBW/m^2'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods 
        function obj=TRadialPowerDensitydBWMeasurement %MUST NOT TAKE ARGUMENTS  
