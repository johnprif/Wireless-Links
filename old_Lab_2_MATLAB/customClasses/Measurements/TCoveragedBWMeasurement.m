classdef TCoveragedBWMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Coverage - dBWatt'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
        Units='dBWatt';
    end
    
    methods 
        function obj=TCoveragedBWMeasurement %MUST NOT TAKE ARGUMENTS  
