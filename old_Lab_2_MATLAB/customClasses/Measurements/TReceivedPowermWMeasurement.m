classdef TReceivedPowermWMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Received Power - mWatt'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods 
        function obj=TReceivedPowermWMeasurement %MUST NOT TAKE ARGUMENTS  
