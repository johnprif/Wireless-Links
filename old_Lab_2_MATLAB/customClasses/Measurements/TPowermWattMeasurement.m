classdef TPowermWattMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Power (mWatt)'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods 
        function obj=TPowermWattMeasurement %MUST NOT TAKE ARGUMENTS  
