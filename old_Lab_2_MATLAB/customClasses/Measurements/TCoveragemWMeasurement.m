classdef TCoveragemWMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Coverage - mWatt'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
        Units='mWatt';
    end
    
    methods 
        function obj=TCoveragemWMeasurement %MUST NOT TAKE ARGUMENTS  
