classdef TPowerdBMeasurement < TMeasurement
    
    properties (Constant)
        GUIName='Power (dBWatt)'; %EVERY MEASUREMENT SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods 
        function obj=TPowerdBMeasurement %MUST NOT TAKE ARGUMENTS  
