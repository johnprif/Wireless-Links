classdef (ConstructOnLoad=true) TFiniteThreeHalfDipoleAntenna < TAntenna
...
%       length=1;    % Dipole Legth in meters
    ...
    properties (Constant)
        GUIName='1.5 Wavelength Dipole'; %EVERY ANTENNA SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods        
        function obj=TFiniteThreeHalfDipoleAntenna   %CONSTRUCTOR MUST NOT TAKE ARGUMENTS!   
        end
