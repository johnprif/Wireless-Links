classdef (ConstructOnLoad=true) TFiniteQuarterDipoleAntenna < TAntenna
...
%       length=1;    % Dipole Legth in meters
    ...
    properties (Constant)
        GUIName='0.25 Wavelength Dipole'; %EVERY ANTENNA SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods        
        function obj=TFiniteQuarterDipoleAntenna   %CONSTRUCTOR MUST NOT TAKE ARGUMENTS!   
        end
