classdef (ConstructOnLoad=true) TFiniteDipoleAntenna < TAntenna
    % Short Dipole.
...
%       length=1;    % Dipole Legth in meters
    ...
    properties (Constant)
        GUIName='Wavelength Dipole'; %EVERY ANTENNA SHOULD DEFINE a GUINAME (see TAntenna)        
    end
    
    methods        
        function obj=TFiniteDipoleAntenna   %CONSTRUCTOR MUST NOT TAKE ARGUMENTS!   
        end
