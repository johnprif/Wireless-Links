...
function LOS_Slider_doIt(src, data, FIRST_GUI)
  set(FIRST_GUI.Label_7,'String',sprintf('LOS\n%.2f%c',get(FIRST_GUI.LOS_Slider,"Value"), '%'));
  set(FIRST_GUI.Label_8,'String',sprintf('NLOS\n%.2f%c',100-get(FIRST_GUI.LOS_Slider,"Value"), '%'));
% This code will be executed when user change the value of slider.
% As default, all events are deactivated, to activate must set the
% propertie 'generateCallbck' from the properties editor
end
...
function Distance__Slider_2_BD_doIt(src, data, FIRST_GUI)
  set(FIRST_GUI.Label_10,'String',sprintf('Distance = %.1fm',get(FIRST_GUI.Distance__Slider_2_BD,"Value")));
% This code will be executed when user change the value of slider.
% As default, all events are deactivated, to activate must set the
% propertie 'generateCallbck' from the properties editor
end
...
function Slider_12_doIt(src, data, FIRST_GUI)
  set(FIRST_GUI.SecondaryPaths,'String',sprintf('Secondary paths = %.0f',get(FIRST_GUI.Slider_12,"Value")));
end
...
function Slider_13_doIt(src, data, FIRST_GUI)
  set(FIRST_GUI.Eb_No,'String',sprintf('Eb/No = %.0fdb',get(FIRST_GUI.Slider_13,"Value")));
end
...
%
  ...
  set(FIRST_GUI.figure, 'visible', 'on');
  ret = FIRST_GUI;
end
