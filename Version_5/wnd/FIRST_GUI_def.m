...
##
## @end deftypefn
function setFigContextWavelDipole(figRec)
   Rin = uicontrol( ...
	'parent',figRec, ... 
	'Style','text', ... 
	'Units', 'pixels', ... 
...
function setFigContextLoopAntenna(figRec)
   diameter = uicontrol( ...
	'parent',figRec, ... 
	'Style','text', ... 
	'Units', 'pixels', ... 
...
function setFigContextShortDipole(figRec)
   diameter = uicontrol( ...
	'parent',figRec, ... 
	'Style','text', ... 
	'Units', 'pixels', ... 
...
function setFigContextHertzianDipole(figRec)
   diameter = uicontrol( ...
	'parent',figRec, ... 
	'Style','text', ... 
	'Units', 'pixels', ... 
...
% propertie 'generateCallback' from the properties editor
  ...
  if(strcmp(antenna_model, "0.25 Wavelength Dipole")==1 || strcmp(antenna_model, "0.5 Wavelength Dipole")==1 || strcmp(antenna_model, "1.5 Wavelength Dipole")==1 || strcmp(antenna_model, "Wavelength Dipole")==1)
       setFigContextWavelDipole(figRec)
  endif
